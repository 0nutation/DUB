...
@register_model_architecture("bart", "bart_kmemb")
def bart_kmemb_architecture(args):
    args.encoder_layers = getattr(args, "encoder_layers", 12)
...
@register_model_architecture("bart", "mbart_kmemb")
def mbart_kmemb_architecture(args):
    args.no_scale_embedding = getattr(args, "no_scale_embedding", False)
    bart_kmemb_architecture(args)



@register_model_architecture("bart", "bart_st")
def bart_st_architecture(args):
...
@register_model_architecture("bart", "mbart_st")
def mbart_st_architecture(args):
    args.no_scale_embedding = getattr(args, "no_scale_embedding", False)
    bart_st_architecture(args)