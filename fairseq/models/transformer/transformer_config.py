...
class TransformerConfig(FairseqDataclass):
    ...
    units_embed_dim: int = field(
        default=768,
        metadata={"help": "embedding dim of units"},
    )
    post_proj: bool = field(
        default=False,
        metadata={"help" : "use linear projection to raise dim from units_embed_dim to enc/dec_embed_dim"},
    )
