...
class TransformerEncoderBase(FairseqEncoder):
    ...
    def __init__(self, cfg, dictionary, embed_tokens, return_fc=False):
        ...
        units_embed_dim = embed_tokens.embedding_dim   #units embedding dim  128
        self.padding_idx = embed_tokens.padding_idx
        embed_dim = cfg.encoder.embed_dim    #transformer encoder/decoder dim  512
    ...
    def forward_embedding(
        ...
        if token_embedding is None:
            token_embedding = self.embed_tokens(src_tokens).transpose(1,2)  #[B,128,T]
        token_embedding = self.conv_pre(token_embedding).transpose(1,2)  #[B,T,512]
    ...
    def reorder_encoder_out(self, encoder_out: Dict[str, List[Tensor]], new_order):
        ...
        encoder_states = (
            ...
            else [x.index_select(1, new_order) for x in encoder_states]
        )
