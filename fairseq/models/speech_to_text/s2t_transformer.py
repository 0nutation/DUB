...
@register_model_architecture("s2t_transformer", "s2t_transformer_hubertrep")
def s2t_transformer_hubertrep(args):
    # Convolutional subsampler
...
@register_model_architecture("s2t_transformer", "s2t_transformer_kmemb")
def s2t_transformer_kmemb(args):
    # Convolutional subsampler
    args.conv_kernel_sizes = getattr(args, "conv_kernel_sizes", "5")
