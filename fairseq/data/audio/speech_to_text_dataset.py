...
import os
speech_form = os.environ.get('speech_form') if os.environ.get('speech_form') is not None else 'speech'
transcript_form = os.environ.get('transcript_form') if os.environ.get('transcript_form') is not None else 'src_text'
# assert speech_form=='speech', 'please set speech_form=speech for speech_to_text task or you can use unit_to_text task'
# assert transcript_form in ['src_text', 'phonemes', 'units', 'chars']
...
class SpeechToTextDatasetCreator(object):
    ...
    # optional columns
    KEY_SPEAKER, KEY_SRC_TEXT = "speaker", transcript_form
